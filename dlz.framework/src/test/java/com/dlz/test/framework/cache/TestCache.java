...
//					bean.put("name"+j,"key"+ finalI,"xxxxx");
    ...
    public void tlist() {
        ...
        List<BeanTest> s = new ArrayList<>();
        s.add(new BeanTest("jsonkey", "xx1"));
        final List<BeanTest> x = CacheUtil.get("x3", "1232", () -> s);
        final List<BeanTest> x2 = CacheUtil.get("x2", "123", () -> s);
        final List<BeanTest> x3 = CacheUtil.getList("x3", "1232", () -> s, BeanTest.class);
        final List<BeanTest> x4 = CacheUtil.getList("x3", "1232", () -> s, BeanTest.class);
    }
