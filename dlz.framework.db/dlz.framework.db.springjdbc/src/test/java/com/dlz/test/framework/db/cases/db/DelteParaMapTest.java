...
public class DelteParaMapTest  extends SpingDbBaseTest {
    ...
    public void conditionSqlTest1_2() {
        ...
        showSql(paraMap,"conditionSqlTest1_2","delete from t_b_dict t where (id='123')");
    }
    @Test
    public void conditionSqlTest1_3() {
        MakerDelete paraMap = DB.delete("t_b_dict");
        paraMap.apply("[id={0}]","");
        showSql(paraMap,"conditionSqlTest1_2","delete from t_b_dict t where false");
    }
    @Test
...
//        paraMap.where(DbBuildEnum.where.build())
    ...
    public void conditionTest() {
        ...
        showSql(paraMap,"conditionTest","delete from t_b_dict t where XXSS <> '3' and A4 = '2' and A6 <= '10' and (A6 = '10' or A6 = '10') and (A6 = '10' and A6 = '10') and (exists (select 1 from dual where t_b_dict where 1=999) )");
    }
    ...
    public void conditionTest3() {
        ...
        ;
        showSql(paraMap,"conditionTest3","delete from t_b_dict t where (XXSS in (3,4,5,6) or XXSS in ('31','111','5','6') or XXSS in (1) or XXSS in (SELECT 2 FROM DUAL))");
    }
