...
public class DeleteMakerTest extends SpingDbBaseTest {
    ...
    public void conditionSqlTest1() {
        TableDelete paraMap = DB.Table.delete("t_b_dict");
    ...
    public void conditionSqlTest1_2() {
        ...
        showSql(paraMap, "conditionSqlTest1_2", "delete from t_b_dict where (id='123') and IS_DELETED = 0");
    }
    ...
    public void conditionSqlTest1_3() {
        TableDelete paraMap = DB.Table.delete("t_b_dict");
        paraMap.apply("[id={0}]", "");
        showSql(paraMap, "conditionSqlTest1_2", "delete from t_b_dict where IS_DELETED = 0");
    }
    ...
    public void conditionSqlTest2() {
        ...
        paraMap.eq("IS_DELETED", 8);

//        showSql(paraMap,"conditionTest1","delete from t_b_dict where IS_DELETED = 0");
        paraMap.execute();
    }
...
//        paraMap.where(DbBuildEnum.where.build())
    ...
    public void conditionTest() {
        ...
        showSql(paraMap, "conditionTest", "delete from t_b_dict where XXSS <> '3' and A4 = '2' and A6 <= '10' and (A6 = '10' or A6 = '10') and (A6 = '10' and A6 = '10') and (exists (select 1 from dual where t_b_dict where 1=999) ) and IS_DELETED = 0");
    }
    ...
    public void DeleteParaMapTest() {
        ...
        TableDelete dh_room = DB.Table.delete("dh_room")
                .where(where);
