...
public class JSONMapConstructionTest {
	...
	@Test
	public void test3_2(){
		JSONMap paras = new JSONMap("a",1,"b",2,"1",new JSONMap(),"1",3);
		System.out.println(paras);
		//输出：{"a":1,"1":3,"b":2}
	}
	/**
	 ...
	 */
	@Test
	public void test3_3_error(){
		JSONMap paras = new JSONMap("a",1,"b",2,"1",new JSONMap(),"1");
		System.out.println(paras);
		//com.dlz.comm.exception.SystemException: 6001:[参数个数只能是偶数]
	}
